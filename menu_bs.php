 ...
 <div class="container-fluid" >
   ...
   <div class="navbar-header">
        <a class="navbar-brand" href="index.php">
          <img src="images/PROYECTO.jpeg" alt="Logo" style="height: 30px; display:inline-block; margin-top: -5px; margin-right: 5px;">
          <span style="font-weight: bold; font-size: 18px;">Gonzalo Silva</span>
        </a>
      </div>
    ...
    <li><a href="ayuda.php">Ayuda</a></li> <!-- Nueva opción Ayuda -->
